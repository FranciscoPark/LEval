...
# hook analysis
# ----------------------------
from hooking import LlamaAttentionHook,LlamaQKCollector
            ...
            for d in tqdm(data, desc=f"Evaluating {file_name}"):
                ...
                for inst, out in zip(instructions, outputs):
                    ...
                    if "sci_fi" in file_name:
                        ...
                        pred2 = tokenizer.decode(
                            gen2[0][prompt_len2:], skip_special_tokens=True
                        )
                    ...
                    # write out everything including attention stats
...
def parse_args():
    ...
    p.add_argument('--task_path', type=str, default=None,
                   help='path to a specific task file or directory')
    p.add_argument('--task_name', type=str, default=None,
                   help='specific huggingface task name')
    p.add_argument('--mc_tasks', action='store_true',
                   help='test all multiple-choice tasks')
    return p.parse_args()
